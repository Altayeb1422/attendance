...
class AttendanceServices {
  postAttenRecStatus() async {
    var res = await http.post(Uri.parse("http://192.168.15.124/hrm/fetch_atten_rec.php"),body: {
      "empID":empID,
   ...
   getAttenRecStatus(id, day) async {
    ...
    var res = await client.get(
      Uri.parse("http://192.168.15.124/hrm/get_atten_rec.php?empID=${id}&RecDate="+day.toString()),);
    if (res.statusCode == 200) {
      print(res.body);
